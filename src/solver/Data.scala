...
object Data {
  ...
  def data = {
    val teachers = Set("Tereza","Dana","Hana","Gita","Martina","Bohunka","Lucka","Iva").map(n => Teacher(n))
  ...
  def data2014 = {
    ...
    TerezaJobs ++ DanaJobs ++ HanaJobs ++ GitaJobs ++ MartinaJobs ++ BohunkaJobs ++ LuckaJobs ++ IvaJobs
  }
